    ...
    scmForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                renderSCMResults(result, config);
 ...
 */
export function renderSCMResults(result, config) {
    ...
    renderSCMTimeSeries(result, config);
...
function renderSCMTimeSeries(result, config) {
    ...
    const layout = {
        ...
        xaxis: {
            title: config?.time_column || 'Tiempo',
            gridcolor: 'rgba(255, 255, 255, 0.1)',
            zerolinecolor: 'rgba(255, 255, 255, 0.1)'
        },
        yaxis: {
            title: config?.target_column || 'Valor',
            gridcolor: 'rgba(255, 255, 255, 0.1)',
            zerolinecolor: 'rgba(255, 255, 255, 0.1)'
        },
        showlegend: true,
